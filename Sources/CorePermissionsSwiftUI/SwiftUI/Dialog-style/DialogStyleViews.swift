...
public extension View {
    ...
    func JMAlert(
        showModal: Binding<Bool>, for permissions: [PermissionManager],
    ...
    func JMAlert(
        ...
        onDisappearHandler: Optional<(_ successful: [JMResult]?, _ erroneous: [JMResult]?
        ) -> Void> = nil
    ) -> some CustomizableView {
        initializeJMAlert(
            showModal: showModal,
    ...
    func JMAlert(
        ...
        onAppear: (() -> Void)? = nil,
        onDisappear: (() -> Void)? = nil,
        onDisappearHandler: Optional<(_ successful: [JMResult]?, _ erroneous: [JMResult]?) -> Void> = nil
    ) -> some CustomizableView {
    ...
    private func initializeJMAlert(
        showModal: Binding<Bool>,
        ...
        onAppear: (() -> Void)? = nil,
        onDisappear: (() -> Void)? = nil,
        onDisappearHandler: (([JMResult]?, [JMResult]?) -> Void)? = nil
    ) -> some CustomizableView {
